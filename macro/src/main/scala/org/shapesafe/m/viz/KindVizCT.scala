...
case object KindVizCT extends VizCTSystem {
  ...
  override val vizFormat: TypeVizFormat = Formats.KindName.Short
  ...
  case object Ovrd extends VizCTSystem {

    override def vizFormat: TypeVizFormat = EnableOvrd(Stub.typeFormat)
    override def useTree: Boolean = false
